...
class Tiny_FT_JNF(BaseModel):
    ...
    def __init__(self,
        ...
        """
        super(Tiny_FT_JNF, self).__init__()
...
if __name__ == '__main__':
    ...
    mod = Tiny_FT_JNF(output_type='Nch_CRM', n_channels=3, channels_to_filter=[0, 1, 2],
