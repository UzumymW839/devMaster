...
class ALLD_ft_jnf(BaseModel):
    ...
    def __init__(self,
                 ...
                 n_freqs: int = 257,
                 n_channels: int = 2,
                 n_lstm_hidden1: int = 80, # basevalue 64 Checked: (72,
                 n_lstm_hidden2: int = 32, # basevalue 16 Checked: (24,
        ...
        """
        super(ALLD_ft_jnf, self).__init__()
...
if __name__ == '__main__':
    ...
    mod = ALLD_ft_jnf(output_type='Nch_CRM', n_channels=3, channels_to_filter=[0, 1, 2],
