...
speech_dataset_path = pathlib.Path(r'/datapool_fast/metzrt/Data/clean_multichannel_speech')

file_lists_path = pathlib.Path(r'file_lists/clean_multichannel_speech')
