...
# BINAURAL DATA
#speech_dataset_path = pathlib.Path(r'/daten_pool/ohlems/BSE_data/reverberated_multichannel_speech')
#file_lists_path = pathlib.Path(r'file_lists/reverberated_multichannel_speech')
#file_lists_path.mkdir(exist_ok=True)
# print("generating file lists for binaural data ...")

# DIAMOND DATA
speech_dataset_path = pathlib.Path(r'/mnt/IDMT-WORKSPACE/DATA-STORE/metzrt/Data/reverberated_multichannel_speech_array')
file_lists_path = pathlib.Path(r'/mnt/IDMT-WORKSPACE/DATA-STORE/metzrt/2023_binauralspeechenhancement/file_lists/diamond_reverberated_multichannel_speech_array')
file_lists_path.mkdir(exist_ok=True)
...
all_files = sorted(list(speech_dataset_path.glob('**/*.wav')))
