...
from metrics.haspi.nalr import NALR
from metrics.haspi.audiogram import Audiogram
...
def loss_parameters(
    hearing_loss: ndarray,
    center_freq: ndarray,
    audiometric_freq=None#: ndarray | None = None,
...
def ave_covary2(
    ...
    threshold_db: float,
    lp_filter_order=None,#: ndarray | None = None,
    freq_cutoff=None,#: ndarray | None = None,
):# -> tuple[float, ndarray]:
    """
